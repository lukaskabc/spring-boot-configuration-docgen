 ...
 *
 * https://github.com/kbss-cvut/termit/blob/master/src/main/java/cz/cvut/kbss/termit/util/Configuration.java
 ...
 */
@ConfigurationProperties("full-termit")
@Primary
@Valid
public class FullTermitConfiguration {
    /**
     * TermIt frontend URL.
     * <p>
